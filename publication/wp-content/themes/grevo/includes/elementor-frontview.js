jQuery( window ).on( 'elementor/frontend/init', function() {
	...
	elementorFrontend.hooks.addAction( 'frontend/element_ready/thsn_event_element.default', function($scope, $){ thsn_carousel(); });
	...
	elementorFrontend.hooks.addAction( 'frontend/element_ready/thsn_gallery_element.default', function($scope, $){ thsn_carousel(); });
